    ...
    <div className="space-y-6 pb-12">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Create a profile for each child to track their chores and rewards.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleAddProfile} className="space-y-4">
            ...
            <Button
              ...
              disabled={!newProfileName.trim() || !canAddProfile}
            >
          ...
          <Card key={profile.id} className="overflow-hidden shadow-none border-slate-100">
            <div className="flex items-center p-4 gap-4">
              ...
              <Button
                ...
                size="icon"
                onClick={() => {
                  if (confirm(`Delete profile for ${profile.name}?`)) deleteProfile(profile.id);
                }}
