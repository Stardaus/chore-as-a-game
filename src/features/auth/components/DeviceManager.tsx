...
export function DeviceManager() {
    const { family, devices, fetchFamily, fetchDevices, generateJoinCode, removeDevice, loading } = useFamilyStore();
        ...
        <div className="space-y-6">
            ...
            <div className="p-4 bg-indigo-600 rounded-3xl text-white shadow-xl shadow-indigo-100 relative overflow-hidden">
                <div className="relative z-10 space-y-3">
                    <div className="flex items-center justify-between">
                        <h4 className="text-sm font-bold uppercase tracking-widest opacity-80">Link New Device</h4>
                    ...
                    <p className="text-[10px] font-medium opacity-70 leading-tight">
                        Enter this code on another device to link it to your family account. 
                        Expires in 24 hours.
                    </p>
                </div>
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between px-1">
                    <h4 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Linked Devices</h4>
                ...
                <div className="grid gap-2">
                    ...
                    {devices.length === 0 && !loading && (
                        <div className="text-center py-6 border-2 border-dashed border-slate-200 rounded-2xl">
                            <p className="text-[11px] text-slate-400 font-medium italic">No other devices linked yet.</p>
                        </div>
                    )}
                </div>
            </div>
